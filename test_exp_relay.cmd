...
"ztool\sys\python\python.exe" -I "ztool/sys/esptool/esp32/esptool.py" --chip esp32 --port %myvar% --baud 460800 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x1000 "ztool/dist/devices/db_zm1/test/exp-relay/bootloader.bin" 0x10000 "ztool/dist/devices/db_zm1/test/exp-relay/zerynth.bin" 0x9000 "ztool/dist/devices/db_zm1/test/exp-relay/partition-table.bin"
echo "-------------------------------------"
echo "             TEST EXP-RELAY          "
echo "-------------------------------------"
