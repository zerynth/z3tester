...
def init_cfg():
    ...
    # print(env.home)
    env.ztc       = fs.get_script_abs_path()
    env.home      = env.ztc.split(fs.path("/dist","ztc"))[0]
    ...
    # dist directories
    env.dist          = fs.path(env.home,"dist")
    # env.ztc           = fs.path(env.home,"dist","ztc")
    ...
    env.devices       = fs.path(env.home,"dist","devices")
    ...
    env.user_agent = "ztc/"+env.var.version
